...
function addTaskInput() {
  document.getElementById("main-container").style.filter = "blur(6px)";
...
function addCard() {
  ...
  headDiv.addEventListener('click', ()=>{
    document.getElementById("mainh1").style.visibility ="hidden" ;
    let headtxt=document.getElementById('middletxt');
      headtxt.style.fontSize="70px" ;
      headtxt.innerText=h.text;
      
    // document.getElementById("middletext").innerText = h.innerText ;
     let backbtn=document.getElementById("backbtn").style.visibility="visible";
    // document.getElementById("backbtn").style.visibility ="visible";
    backbtn.addEventListener("click",()=>{
      
      document.getElementById("mainh1").style.visibility = "visible";
